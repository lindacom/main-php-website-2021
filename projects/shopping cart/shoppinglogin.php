...
<title>Login and sign up form</title>
  ...
  <meta name="viewport" content="width=device-width, initial-scale=1">
   <link rel="stylesheet" href="m/css/app.scss">
...
<hr />
          ...
          <div class="grid-x grid-margin-x" style="background-color:#AF4CAB;margin: 20 auto; padding:20px;">
...
<div>
    ...
    <div>
            <input type="email" id="tbsuemail" name="txtsuemail" placeholder="Email*" required>
